...
public class Main extends JPanel {
	...
	private final static String SEPARATOR = "===================";//string used by the app to separate messages
	private final static String BEGINNING = "Auto-generated with the Email Text Messages app for Android // www.emailtextmessages.net\n";//header generated by app

	//Hangouts colors
	private final static Color BLACK = new Color(38, 50, 56);
	private final static Color OFF_WHITE = new Color(236, 239, 241);
	private final static Color GREEN = new Color(15, 157, 88);
	private final static Color GREY = new Color(207, 216, 220);

	//Fonts
	private static Font titleFont = new Font("Dialog", Font.BOLD, 24);
	private static Font normalFont = new Font("Dialog", Font.PLAIN, 16);

	private static LinkedList<Text> textMessages = new LinkedList<>();//List of texts
	private static Main main;//The panel, used to draw the image
	private static String otherGuy = "Them";//sender name
	private static String wholeText = "";
	private static String hangoutsText = "";
	...
	@SuppressWarnings("unchecked") private static void createScreenshot()
	...
	@SuppressWarnings({ "unchecked", "deprecation" }) private static void printData() {
		/*
		 * Data:
		...
		wholeText = wholeText.replace(BEGINNING, SEPARATOR);
		ArrayList<String> fromMe = new ArrayList<>();
		ArrayList<String> toMe = new ArrayList<>();
		String prevSender = "";
		ArrayList<String> prevMessage = new ArrayList<>();
		...
		ArrayList<Integer> datesList = new ArrayList<>(dates.values());
	...
	@SuppressWarnings("deprecation") @Override public void paint(Graphics g) {//graphics code goes here
		int y = 0;
	...
	private int paintTitle(Graphics g, int y, String title) {
		g.setFont(titleFont);
	...
	private int paintSMS(Graphics g, int y, Text sms) {
	...
	private static int paintTitleTest(int y) {//outputs same y value, draws nothing
	...
	private static int paintSMSTest(int y, Text sms) {//same y result as original
		frame.setFont(normalFont);
		for (int i = 0; i < sms.getMessage().size(); i++) {
	...
	private static void saveAsImage() throws InterruptedException {
	...
	private static Date getDate(String datetime)
			throws ParseException {//gets Date object from string date
		return new SimpleDateFormat("EEE dd MMM yyyy - hh:mm:ss aa").parse(datetime);
	}

	private static String getDayName(int day) {//gets day name from day #
